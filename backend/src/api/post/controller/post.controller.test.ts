...
import { getMockPostStats, getMongoId } from "../../../services/test/test-util.service";
...
jest.mock("../services/post-stats/post-stats.service");
...
jest.mock("../models/poll-vote/poll-vote.model", () => ({
  PollVoteModel: {
    create: jest.fn(),
  },
}));
